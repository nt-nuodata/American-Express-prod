...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_EMPLOYEE_PROFILE_v2_0


df_0 = spark.sql("""SELECT
  EMPLOYEE_ID_v2 AS EMPLOYEE_ID_v2,
  EMPL_FIRST_NAME AS EMPL_FIRST_NAME,
  EMPL_MIDDLE_NAME_v2 AS EMPL_MIDDLE_NAME_v2,
...
df_0.createOrReplaceTempView("Shortcut_to_EMPLOYEE_PROFILE_v2_0")
...
df_1 = spark.sql("""SELECT
  EMPLOYEE_ID_v2 AS EMPLOYEE_ID,
  EMPL_FIRST_NAME AS EMPL_FIRST_NAME,
  EMPL_LAST_NAME AS EMPL_LAST_NAME,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_EMPLOYEE_PROFILE_v2_0
WHERE
  EMPL_STATUS_CD <> 'T'""")
